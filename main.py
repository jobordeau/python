...
if __name__ == '__main__':
    ...
    # Une version où l'on peut directement les colonnes dans un paramètre, et les listes de valeurs dans un second
    # paramètre.
    df2 = mb.DataFrame([[45, -5, 8], [78, 9, 10, 900]], ["Serie 1", "Serie 2"])
    print(df2)
